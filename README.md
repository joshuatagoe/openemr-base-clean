...
**Tests.** Agent: `uv run pytest` in `copilot-agent/` — 822 passed, 7 skipped (the opt-in live tiers), up from 302 at the end of Week 1. The eval gate runs this suite as its first stage; `tests/test_api_collection.py` needs the Bruno CLI. Module: 247 / 247 PHPUnit, up from 57; panel: 109 / 109 jest. Golden set: 71 cases, all five rubrics at 1.00.
